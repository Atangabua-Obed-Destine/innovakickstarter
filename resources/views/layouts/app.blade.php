...
<body class="antialiased" x-data="{ sidebarOpen: false }">
    ...
    <header class="navbar">
        ...
        <div class="flex items-center gap-3">
            ...
            <!-- Notifications -->
            <button class="relative p-2 text-dark-400 hover:text-dark-100 hover:bg-dark-800 rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if(auth()->user()->hasRole('fellow'))
                <a href="{{ route('activities.create') }}" class="btn btn-primary btn-sm hidden sm:inline-flex">
    ...
    @if(auth()->user()->hasRole('fellow'))
    <nav class="fixed bottom-0 left-0 right-0 bg-dark-900 border-t border-dark-800 lg:hidden z-40">
        <div class="flex items-center justify-around py-2">
            <a href="{{ route('dashboard') }}" class="flex flex-col items-center gap-1 p-2 text-dark-400 hover:text-primary-400">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                </svg>
                <span class="text-xs">Home</span>
            </a>
            <a href="{{ route('activities.index') }}" class="flex flex-col items-center gap-1 p-2 text-dark-400 hover:text-primary-400">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/>
                </svg>
                <span class="text-xs">Activities</span>
            </a>
            <a href="{{ route('activities.create') }}" class="flex flex-col items-center gap-1 p-2">
                <div class="w-12 h-12 -mt-6 bg-gradient-to-br from-primary-600 to-accent-600 rounded-full flex items-center justify-center shadow-lg shadow-primary-600/30">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>
                </div>
                <span class="text-xs text-primary-400">Log</span>
            </a>
            <a href="{{ route('interviews.index') }}" class="flex flex-col items-center gap-1 p-2 text-dark-400 hover:text-primary-400">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                </svg>
                <span class="text-xs">Interviews</span>
            </a>
            <a href="{{ route('profile.show') }}" class="flex flex-col items-center gap-1 p-2 text-dark-400 hover:text-primary-400">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
