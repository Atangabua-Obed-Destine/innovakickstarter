...
<div class="space-y-6">
    <div>
        <h1 class="text-2xl font-bold text-white">Payment Records & Verifications</h1>
        <p class="text-dark-400">Review, approve, or delete payment receipts and admin entries.</p>
    </div>
                        ...
                        <tr class="border-b border-dark-700/50 hover:bg-dark-800/50 transition-colors">
                            ...
                            <td class="p-3 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form action="{{ route('admin.payment-verifications.destroy', $payment) }}" method="POST" onsubmit="return confirm('Are you sure you want to permanently delete this payment record? The financial balances will be automatically corrected. This cannot be undone.');" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-outline border-red-500/50 text-red-400 hover:bg-red-500/10 py-1 px-2 text-xs" title="Delete Payment Record">
